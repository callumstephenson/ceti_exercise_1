def mixer(fresh_feed_co, fresh_feed_aa, oil_recycle, acid_recycle, out_stream):
    ...
    out_stream_molflow = fresh_feed_co.mol_flow + fresh_feed_aa.mol_fxlow + acid_recycle.mol_flow + oil_recycle.mol_flow
    out_stream_massflow = fresh_feed_co.mass_flow + fresh_feed_aa.mass_flow + acid_recycle.mass_flow + oil_recycle.mass_flow
    ...
    out_stream.update(new_massflow = out_stream_massflow, new_molflow = out_stream_molflow, co_delta = out_stream_co_delta, aco_delta = out_stream_aco_delta, dco_delta = out_stream_dco_delta, aa_delta = out_stream_aa_delta, water_delta = out_stream_water_delta, gum_delta = out_stream_gum_delta)
    return None