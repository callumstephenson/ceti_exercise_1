...
def run():
    ...
    for i in range(250, 340, 10):
        ...
        for j in range(0, 2):
            stream_1, stream_2, stream_3, stream_4, stream_5, stream_6, stream_7, stream_8, stream_9, stream_10, stream_11, stream_12, stream_13 = plant(5360, 10000, true_index[j], i)
